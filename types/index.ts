...
export type NextPageWithParamsProps = {
	params: { slug: string };
...
export type XDHubSpotWithImageProps = {
	entry: Contentful.TypeXdHubSpotWithImage<
		'WITHOUT_UNRESOLVABLE_LINKS',
		'en-US'
	>;
};
...
export type XDImageWthTextProps = {
	entry: Contentful.TypeXdImageWithText<
		'WITHOUT_UNRESOLVABLE_LINKS',
		'en-US'
	>;
};
...
export type XDNavigationMenuProps = {
	entry: Contentful.TypeXdNavigationMenu<
		'WITHOUT_UNRESOLVABLE_LINKS',
		'en-US'
	>;
	fixedHeader: boolean;
...
export type XDNavItemProps = {
	entry: Contentful.TypeXdNavigationItem<
		'WITHOUT_UNRESOLVABLE_LINKS',
		'en-US'
	>;
	fixedHeader?: boolean;
...
export type XDSetOfProgressBarProps = {
	entry: Contentful.TypeXdSetOfProgressBar<
		'WITHOUT_UNRESOLVABLE_LINKS',
		'en-US'
	>;
};
export type XDSetOfCallToActionProps = {
	entry: Contentful.TypeXdSetOfCallToAction<
		'WITHOUT_UNRESOLVABLE_LINKS',
		'en-US'
	>;
};
...
export type XDSetOfTeamMembersProps = {
	entry: Contentful.TypeXdSetOfTeamMembers<
		'WITHOUT_UNRESOLVABLE_LINKS',
		'en-US'
	>;
};
...
export type XDTestimonialCardProps = {
	entry: Contentful.TypeXdTestimonialCard<
		'WITHOUT_UNRESOLVABLE_LINKS',
		'en-US'
	>;
};
